...
public class GuiStandingSettings extends GuiVROptionsBase
{
    ...
    protected void loadDefaults()
    {
        ...
        vrsettings.vrShowBlueCircleBuddy = true;
        vrsettings.walkMultiplier = 1.0F;
        vrsettings.vehicleRotation = true;
        vrsettings.walkUpBlocks = true;
        vrsettings.vrWorldRotationIncrement = 45.0F;
        vrsettings.allowStandingOriginOffset = false;
        vrsettings.forceStandingFreeMove = false;
    }
}
