...
{
    private VROptionLayout[] vrAlwaysOptions = new VROptionLayout[] {new VROptionLayout(GuiHUDSettings.class, VROptionLayout.Position.POS_LEFT, 1.0F, true, "vivecraft.options.screen.gui.button"), new VROptionLayout(GuiRenderOpticsSettings.class, VROptionLayout.Position.POS_LEFT, 0.0F, true, "vivecraft.options.screen.stereorendering.button"), new VROptionLayout(GuiQuickCommandEditor.class, VROptionLayout.Position.POS_RIGHT, 0.0F, true, "vivecraft.options.screen.quickcommands.button"), new VROptionLayout(GuiOtherHUDSettings.class, VROptionLayout.Position.POS_RIGHT, 1.0F, true, "vivecraft.options.screen.guiother.button"), new VROptionLayout(VRSettings.VrOptions.WORLD_SCALE, VROptionLayout.Position.POS_LEFT, 6.0F, true, (String)null), new VROptionLayout(VRSettings.VrOptions.WORLD_ROTATION, VROptionLayout.Position.POS_RIGHT, 6.0F, true, (String)null), new VROptionLayout(VRSettings.VrOptions.PLAY_MODE_SEATED, (button, mousePos) -> {
            this.reinit = true;
    ...
    {
        this.minecraft.vrSettings.vrWorldRotation = 0.0F;
        MCVR.get().seatedRot = 0.0F;
        this.minecraft.vrSettings.vrWorldScale = 1.0F;
        this.minecraft.vrSettings.vrWorldRotationIncrement = 45.0F;
        this.minecraft.vrSettings.seated = false;
